...
Nhập giá trị 1 node X. Kiểm tra X có trên cây hay không? Nếu tìm thấy X và X là node có 2 con thì tìm node có giá trị lớn nhất nằm ở nhánh cây con bên trái của X (max_left)
Ví dụ:
...
Nhập X=9. Xuất ra giá trị max_left = 7
INPUT
...
- Nếu tìm thấy node X và X là node 2 con --> xuất giá trị max_left */
