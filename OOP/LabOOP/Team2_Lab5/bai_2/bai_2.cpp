...
private:
    ...
    void Xuat() {
        cout << "Doi tuong: Hoc sinh. " << endl;
        Nguoi::XuatThongTin();
        cout << "Ban dang hoc lop: " << Lop << endl;
...
public:
    ...
    void Xuat() {
        cout << "Doi tuong: Cong nhan. " << endl;
        Nguoi::XuatThongTin();
        cout << "Muc luong cua ban: " << Luong << endl;
        cout << "Ban dang lam viec tai cong ty: " << TenCongTy << endl;
    }
};
...
public:
    ...
    void Xuat() {
        cout << "Doi tuong: Ca si." << endl;
        Nguoi::XuatThongTin();
        cout << "Thu nhap cua ca si: " << CatXe << endl;
...
{
    ThongKe A;
    A.NhapThongTinDoiTuong();
    A.XuatThongTinDoiTuong();
    return 0;
}
